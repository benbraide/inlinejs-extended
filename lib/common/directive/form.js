...
exports.FormDirectiveHandler = (0, inlinejs_1.CreateDirectiveHandlerCallback)(names_1.FormDirectiveName, ({ componentId, component, contextElement, expression, argKey, argOptions }) => {
    ...
    let fieldExpressions = new Array(), evaluateFieldExpressions = () => {
        fieldExpressions.filter(info => (info.source === contextElement || contextElement.contains(info.source))).forEach((info) => {
            (0, inlinejs_1.EvaluateLater)({ componentId, contextElement: info.source, expression: info.value })(value => ((0, inlinejs_1.IsObject)(value) && (fields = Object.assign(Object.assign({}, fields), value))));
        });
    };
    let handleEvent = (e) => {
