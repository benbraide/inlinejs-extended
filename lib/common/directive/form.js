...
exports.FormDirectiveHandler = (0, inlinejs_1.CreateDirectiveHandlerCallback)(FormDirectiveName, ({ componentId, component, contextElement, expression, argKey, argOptions }) => {
    var _a;
    ...
    if (argKey === 'field') {
        return (0, inlinejs_1.EvaluateLater)({ componentId, contextElement, expression })((value) => {
            var _a;
            if ((0, inlinejs_1.IsObject)(value)) {
                ...
                if (proxy && !(0, inlinejs_1.GetGlobal)().IsNothing(proxy)) {
    ...
    let handleEvent = (e) => {
        ...
        (0, inlinejs_1.GetGlobal)().GetFetchConcept().Get(url, info).then(res => res.json()).then((response) => {
            ...
            (0, inlinejs_1.JournalTry)(() => {
                    ...
                    Object.entries((0, inlinejs_1.IsObject)(failed) ? failed : {}).forEach(([key, value]) => {
                        ...
                        if (form && !options.novalidate) { //Set validation error
                            ...
                            if (item && (item instanceof HTMLInputElement || item instanceof HTMLTextAreaElement || item instanceof HTMLSelectElement)) {
                                item.setCustomValidity(Array.isArray(value) ? value.map(v => (0, inlinejs_1.ToString)(v)).join('\n') : (0, inlinejs_1.ToString)(value));
                ...
                if (response.hasOwnProperty('redirect')) {
                    ...
                    form.reset();
                    (_b = (0, inlinejs_1.FindComponentById)(componentId)) === null || _b === void 0 ? void 0 : _b.GetBackend().changes.AddNextTickHandler(() => form === null || form === void 0 ? void 0 : form.dispatchEvent(new CustomEvent(`${FormDirectiveName}.reset`)));
                }
                if (after) {
                    after();
                }
            ...
            updateState('active', false);
            (0, inlinejs_1.JournalError)(err, `InlineJS.${FormDirectiveName}.HandleEvent`, contextElement);
        });
    };
    (_a = resolvedComponent.FindElementScope(contextElement)) === null || _a === void 0 ? void 0 : _a.SetLocal(localKey, (0, inlinejs_1.CreateInplaceProxy)((0, inlinejs_1.BuildGetterProxyOptions)({
        getter: (prop) => {
            var _a;
