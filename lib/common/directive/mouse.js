...
function BindMouseRepeat(component, contextElement, delay, debounce, callback) {
    var _a;
...
exports.MouseDirectiveHandler = (0, inlinejs_1.CreateDirectiveHandlerCallback)('mouse', ({ componentId, component, contextElement, expression, argKey, argOptions }) => {
    ...
    if (argKey === 'inside') {
        ...
        BindMouseRepeat((component || (0, inlinejs_1.FindComponentById)(componentId)), contextElement, options.delay, options.debounce, streak => evaluate(undefined, [streak], { streak }));
    }
});
