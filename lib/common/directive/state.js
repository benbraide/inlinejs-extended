...
function BindState(componentId, component, contextElement) {
    ...
    let getMessage = () => {
        var _a;
        if (message !== null) {
            (_a = (0, inlinejs_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes.AddGetAccess(`${id}.message`);
            return message;
        }
...
exports.StateDirectiveHandler = (0, inlinejs_1.CreateDirectiveHandlerCallback)(StateDirectiveName, ({ componentId, component, contextElement }) => {
