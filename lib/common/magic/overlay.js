...
exports.OverlayMagicHandler = void 0;
...
function CreateOverlayProxy() {
    ...
    return (0, inlinejs_1.CreateInplaceProxy)((0, inlinejs_1.BuildProxyOptions)({
        ...
        setter: (prop, value) => {
            ...
            else if (prop === 'styles' && (0, inlinejs_1.IsObject)(value)) {
                RemoveOverlayStyles();
                OverlayStyles = value;
                ApplyOverlayStyles();
            }
...
exports.OverlayMagicHandler = (0, inlinejs_1.CreateMagicHandlerCallback)('overlay', () => OverlayProxy);
function OverlayMagicHandlerCompact() {
    (0, inlinejs_1.AddMagicHandler)(exports.OverlayMagicHandler);
}
