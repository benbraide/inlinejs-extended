...
exports.ServerMagicHandler = void 0;
exports.ServerMagicHandlerCompact = ServerMagicHandlerCompact;
const inlinejs_1 = require("@benbraide/inlinejs");
const names_1 = require("../names");
function CreateServerProxy() {
    let getConcept = () => (0, inlinejs_1.GetGlobal)().GetConcept(names_1.ServerConceptName);
    let methods = {
...
exports.ServerMagicHandler = (0, inlinejs_1.CreateMagicHandlerCallback)(names_1.ServerConceptName, () => ServerProxy);
