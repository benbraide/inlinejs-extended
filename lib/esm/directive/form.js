...
import { FindComponentById, AddDirectiveHandler, CreateDirectiveHandlerCallback, EvaluateLater, GetGlobal, JournalError, JournalTry, AddChanges, BuildGetterProxyOptions, CreateInplaceProxy, UseEffect, IsObject, ToString, BindEvent, ResolveOptions, DeepCopy } from "@benbraide/inlinejs";
...
export const FormDirectiveHandler = CreateDirectiveHandlerCallback(FormDirectiveName, ({ componentId, component, contextElement, expression, argKey, argOptions }) => {
    ...
    if (argKey === 'field') {
        let evaluate = EvaluateLater({ componentId, contextElement, expression }), savedData = null;
