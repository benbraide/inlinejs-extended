import { FindComponentById, AddDirectiveHandler, CreateDirectiveHandlerCallback, EvaluateLater, JournalError, AddChanges, BuildGetterProxyOptions, CreateInplaceProxy, BindEvent, ResolveOptions, IntersectionObserver } from "@benbraide/inlinejs";
...
export const IntersectionDirectiveHandler = CreateDirectiveHandlerCallback(IntersectionDirectiveName, ({ componentId, component, contextElement, expression, argKey, argOptions }) => {
    ...
    observer.Observe(contextElement, ({ id, entry } = {}) => {
        ...
        options.once && ((_a = FindComponentById(componentId)) === null || _a === void 0 ? void 0 : _a.RemoveIntersectionObserver(id));
    });
