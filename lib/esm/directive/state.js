import { FindComponentById, AddDirectiveHandler, CreateDirectiveHandlerCallback, GetGlobal, AddChanges, BuildGetterProxyOptions, CreateInplaceProxy } from "@benbraide/inlinejs";
...
function BindState(componentId, component, contextElement) {
    ...
    let getMessage = () => {
        ...
        (_a = GetGlobal().GetCurrentProxyAccessStorage()) === null || _a === void 0 ? void 0 : _a.Put({ componentId, path: `${id}.message` });
        return {
    ...
    if (isFormElement) {
        ...
        elementScope === null || elementScope === void 0 ? void 0 : elementScope.AddTreeChangeCallback(({ added }) => added.filter(child => !(child instanceof HTMLTemplateElement)).forEach((child) => {
            var _a;
            (_a = FindComponentById(componentId)) === null || _a === void 0 ? void 0 : _a.CreateElementScope(child);
            BindState(componentId, FindComponentById(componentId), child);
        }));
